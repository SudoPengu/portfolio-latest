...
function About({ }: Props) {
    return (
        <div className='px-5 z-10'>
            ...
            {/* Bio */}
            <div className='pt-2'>
                <h1 className='text-black dark:text-white text-xl underline pb-5 underline-offset-4 decoration-lime-600 decoration-2 font-bold'>Bio</h1>
            ...
            {/* Interest */}
            <div className='py-2'>
                <h1 className='text-black dark:text-white text-xl underline underline-offset-4 decoration-lime-600 decoration-2 font-bold'>Interest</h1>
                <h1 className='text-black dark:text-white py-2 text-justify indent-5'><span className='text-lime-600'>Pixel Arts</span>, Music, Playing Instruments(Drums, Piano, Guitar, Bass), <span className='text-lime-600'>Programming</span>, and <span className='text-lime-600'>Hacking</span></h1>
            </div>
