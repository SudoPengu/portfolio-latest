    ...
    return (
        <div className='text-white px-9'>
            ...
            <div className='grid md:grid-cols-2'>
                ...
                <Link className='py-5 md:px-5' href={"/projects/underconstruction"}>
                    <div className='text-center'>
                        <Image className='rounded-lg w-full md:h-32' src={PortfolioOld} alt={"Cropture Image"} />
                ...
                <Link className='py-5 md:px-5' href={"/projects/underconstruction"}>
                    <div className='text-center'>
                        <Image className='rounded-lg md:h-32 justify-center' src={AmanungSisuan} alt={"Cropture Image"} />
