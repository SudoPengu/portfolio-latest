            ...
            <div className='dark:text-white text-black py-16'>
                ...
                <div className='flex space-x-2'>
                    ...
                    <div className='pt-1.5'>
                        <div className='text-[0.7rem] disabled:opacity-75 dark:bg-[#3F4142] bg-white font-bold w-16 text-center'>2019-2020</div>
                    </div>
                </div>

                {/* About Project */}
                <div className='py-2'>
                    <h1 className='dark:text-white text-black text-sm py-2 text-justify indent-5'>My first attempt in creating portfolio website.</h1>
