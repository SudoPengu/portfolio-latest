                ...
                <div className='py-2'>
                    ...
                    <div className='grid grid-cols-1'>
                        ...
                        <div className='py-1 inline-flex'>
                            ...
                            <a className='text-sm pl-2 text-lime-600 hover:underline' href='https://github.com/cjgamos/AmanungSisuan' target="_blank" rel="noreferrer">https://github.com/cjgamos/AmanungSisuan</a>
                        </div>
                    </div>
                </div>
